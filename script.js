...
<p>技術：上至規格極高的 Adobe，下至支援手機的 Capcut，剪片工具林林總總，除了講解通用技能 (Transferable Skills)，課程刻意選用 KdenLive，強調開源文化對科技發展的重要性。</p>
`,
  `<h2>主題：軟硬，齊Take曬</h2>
...
`,
  `<h2>主題：光雕王</h2>
<p>介紹：光雕不止是投影，在各種表面躍動光與影，或平、或曲，或如生命的起伏。 *光雕王是 100% 由 Pi 生成的教材 **Pi = Peter + AI</p>
<p>技術：市面上有不同用於光雕的軟件，但大多都要收費，「光雕王」是一個免費的網頁應用程式，由資訊及通訊科技科的導師們配合Vibe coding 製作，當中使用了「廣播頻道 API」，支援多個投影機畫面輸出，並組合成一個光雕創作。</p>
`,
  `<h2>主題：AI編程</h2>
<p>介紹：中四課程響應 AI 趨勢，透過代碼生成進行不同創作。遊戲？得！繪畫板？得！手勢偵測？得！...AI 賦能，令從未想像的變成可能！</p>
...
<p>技術：互動裝置的重心離不開 IPO，活化舊式 IP Cam 讀取 MJPEG / RTSP 等多重視訊來源，透過 CocoSSD 捕捉人像轉化成角度，計算直線交點生成漣漪與魚，最終利用光雕王分拆視訊至兩部投影機於彎曲天幕併合影像。</p>
`,
  `<h2>主題：書院暢遊-塗鴉相集</h2>
  ...
  <p>技術：GIS (地理資訊系統) 通常集成 OpenStreetMap、Leafletjs 等現成工具，這個 WebApp 則從 SVG 素材起自製校舍地圖，結合最初同學提出意念 (塗鴉日記)，最終眾包合力填入活動座標。除了瀏覽資訊，拍照記錄更會即時以光雕王投影到幾幅大地圖。</p>
`,
  `<h2>主題：創意書院的逃犯</h2>
